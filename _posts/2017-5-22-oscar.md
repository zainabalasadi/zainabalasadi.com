...
<div class="{{ site.site-case-break }}" markdown="0">
   <img class="cap" src="../assets/images/oscar/oscar_old_onboard.jpg">
...
My first hypothesis was that there wasn't a clear division between Sign Up and Log in as the terminology for these buttons wasnʼt quite right. So I experimented with new UIs that did just that but to my surprise, this had no benefit… new and existing users still occasionally switched between the two.
</div>
...
<div class="{{ site.site-case-break }}" markdown="0">
   ...
   <p class="caption-between light">The evolution of the onboarding flow.</p>

   <img class="cap" alt="Onboarding testing feedback" src="../assets/images/site/grey.jpg">
   <p class="caption light">The evolution of the onboarding flow.</p>
</div>
...
![](../assets/images/oscar/oscar_search_sketches.jpg)
