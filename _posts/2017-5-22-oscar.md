...
>Why was this happening? Was there not a clear division between Sign Up and Log in?
{: {{site.site-case-quote}}}

My first hypothesis was that the terminology for these buttons wasnʼt quite right. So I experimented with new UIs that did just that but to my surprise, this had no benefit… new and existing users still occasionally switched between the two.
